...
namespace CafeManager {
    ...
    public class dtaTime : DataSet {
        ...
        protected dtaTime(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dtaTime cln = ((dtaTime)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dtaTime";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dtaTime.xsd";
