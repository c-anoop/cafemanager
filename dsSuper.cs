...
namespace CafeManager {
    ...
    public class dsSuper : DataSet {
        ...
        protected dsSuper(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsSuper cln = ((dsSuper)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsSuper";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsSuper.xsd";
