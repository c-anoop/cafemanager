...
namespace CafeManager {
    ...
    public class dsCharge : DataSet {
        ...
        protected dsCharge(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsCharge cln = ((dsCharge)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsCharge";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsCharge.xsd";
