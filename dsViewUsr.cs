...
namespace CafeManager {
    ...
    public class dsViewUsr : DataSet {
        ...
        protected dsViewUsr(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsViewUsr cln = ((dsViewUsr)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsViewUsr";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsViewUsr.xsd";
