...
namespace CafeManager {
    ...
    public class dsFullMem : DataSet {
        ...
        protected dsFullMem(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsFullMem cln = ((dsFullMem)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsFullMem";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsFullMem.xsd";
