...
namespace CafeManager {
    ...
    public class dsSuperSec : DataSet {
        ...
        protected dsSuperSec(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsSuperSec cln = ((dsSuperSec)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsSuperSec";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsSuperSec.xsd";
